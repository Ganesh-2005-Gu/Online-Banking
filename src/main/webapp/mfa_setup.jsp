        ...
        <body class="bg-mfa">
            ...
            <div class="mfa-container">
                ...
                <div class="mfa-options">
                    <div class="mfa-option active" onclick="selectMethod('TOTP')">
                        <h3>Authenticator App</h3>
                        <p>Use Google Authenticator, Authy, or similar apps.</p>
                    </div>
                    <div class="mfa-option" onclick="selectMethod('EMAIL')">
                        <h3>Email OTP</h3>
                ...
                <div id="totp-section">
                    <div class="step">
                        <h4><span class="step-number">1</span>Install an Authenticator App</h4>
                        <p>Download Google Authenticator or Authy on your mobile device.</p>
                    </div>

                    <div class="step">
                        <h4><span class="step-number">2</span>Scan QR Code</h4>
                        <p>Open the app and scan this QR code:</p>
                        <div class="qr-code">
                            <img src="${qrCodeUrl}" alt="MFA QR Code">
                        </div>
                        <p style="text-align: center; font-size: 0.9em; color: #666;">Or enter this key manually:</p>
                        <div class="secret-key">${secret}</div>
                    </div>

                    <div class="step">
                        <h4><span class="step-number">3</span>Verify Code</h4>
            ...
            <script>
                function selectMethod(method) {
                    ...
                    if (method === 'TOTP') {
                        ...
                        document.querySelector('.mfa-option:nth-child(3)').classList.add('active');
